...
(defvar vhdl-align-type-ind-column-alt 36) 
(defvar vhdl-align-port-colon-column 22) ; colon in other declarations
(defvar vhdl-align-port-colon-column-alt 36) 
(defvar vhdl-align-assoc-column 26) 
(defvar vhdl-align-assoc-column-alt 36) 
(defvar vhdl-align-comment-column 48)
(defvar vhdl-align-comment-column-alt 76)
(defvar vhdl-align-assign-column-offset 32) ;; column offeset for "<=" or ":="
(defvar vhdl-align-assign-column-offset-alt 48) ;; column offeset for "<=" or ":="
...
(setq vhdl-align-assign-column-offset-alt 48) ;; column offeset for "<=" or ":="
)
